          ...
          <div className="mb-16">
            <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
              ...
              <aside className="lg:col-span-5">
                <div className="lg:sticky lg:top-28 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h2 className="font-semibold text-lg">Request quotes</h2>
                      <p className="text-sm text-slate-400">Choose a service and a neighborhood. We will follow up with providers who serve that area.</p>
                    </div>
                  </div>
                  <UniversalLeadForm />
                </div>
