      ...
      <main className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            {/* SIDEBAR - Sticky with enhanced content */}
              ...
              <div className="lg:sticky lg:top-24 space-y-6">
                ...
                <div className="bg-[#12161f] border border-white/10 rounded-xl p-6">
                  ...
                  <div className="space-y-2">
                    {sidebarLocations.map(([locationSlug, loc]) => (
                      <Link
                        key={locationSlug}
                        href={`/services/${params.service}/${locationSlug}`}
                ...
                <div className="bg-[#12161f] border border-white/10 rounded-xl p-6">
                  ...
                  <p className="text-sm text-slate-400 mb-4">
                    Choose your neighborhood to see pricing and availability.
                  </p>
                  <Link
                    href={getStartedHref}
                    className="block text-center px-4 py-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-xl transition"
                  >
                    Get started →
                  </Link>
                </div>
